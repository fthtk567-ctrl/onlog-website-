    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-green-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="p-8">
              <div className="bg-green-100 rounded-full w-16 h-16 flex items-center justify-center mb-6 group-hover:bg-green-600 transition">
                <Code className="w-8 h-8 text-green-600 group-hover:text-white transition" />
              </div>
          ...
          >
            <div className="p-8">
              <div className="bg-green-100 rounded-full w-16 h-16 flex items-center justify-center mb-6 group-hover:bg-green-600 transition">
                <Smartphone className="w-8 h-8 text-green-600 group-hover:text-white transition" />
              </div>
